    ...
    class musteriKayit
    {
        ...
        public  void kayitAl(string adi, string soyadi, string cinsiyet, string telefonNo, string mail, string tcNo, string odaAdi, string ucret, DateTime giris, DateTime cikis)
        {
            ...
            try
            {
                ...
                System.Windows.Forms.MessageBox.Show("Müşteri kayıdı başarılı bir şekilde oluşmuştur: " + odaAdi + " numaralı oda " + adi + " " + soyadi + " kişiye verilmiştir", "Bilgi", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Information);
                kayit_Al.Dispose();
